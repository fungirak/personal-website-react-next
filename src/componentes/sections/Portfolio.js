                ...
                <h2  className="text-center fw-normal neomorph-out-element text-electric-green section-title-glow p-3">
                    ...
                    <div className="col-12 col-md-4  p-2">
                        <div className="neomorph-out-element p-3 rounded d-flex flex-column align-items-center text-center"
                            ...
                            <div className="text-center mt-3 d-flex justify-content-center flex-wrap" style={{ width: '100%' }}>
                                ...
                                <a href="https://github.com/fungirak/new-fungirak-website-2022" target="_blank" rel="noopener noreferrer" className="neomorph-project-button" style={{ padding: '0.5rem 0.8rem', fontSize: '0.85rem', marginBottom: '0.5rem' }}>
                    ...
                    <div className="col-12 col-md-4  p-2">
                        <div className="neomorph-out-element p-3 rounded d-flex flex-column align-items-center text-center"
                            ...
                            <div className="text-center mt-3 d-flex justify-content-center flex-wrap" style={{ width: '100%' }}>
                                <a href="https://proyecto-arg-prog-frontend.web.app" target="_blank" rel="noopener noreferrer" className="neomorph-project-button" style={{ padding: '0.5rem 0.8rem', fontSize: '0.85rem', marginRight: '0.5rem', marginBottom: '0.5rem' }}>
                                    <Image src={logoFlecha.src} alt="Abrir" width={18} height={18} />
                                    <span className="fw-bold">ABRIR</span>
                                </a>
                                <a href="https://github.com/fungirak" target="_blank" rel="noopener noreferrer" className="neomorph-project-button" style={{ padding: '0.5rem 0.8rem', fontSize: '0.85rem', marginBottom: '0.5rem' }}>
                                    <Image src={logoGithub.src} alt="Código" width={18} height={18} />
                                    <span className="fw-bold">CÓDIGO</span>
                                </a>
                            </div>
